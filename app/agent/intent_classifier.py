...
INTENT_DEFINITIONS = {
    ...
    "Procedure_Explain": {
        ...
        "keywords": ["什么是", "什么叫", "什么意思", "解释一下", "科普", "原理", "怎么做"],
...
STRONG_INTENT_KEYWORDS = {
    "Lead_Generation": ["预约", "挂号", "帮我预约", "安排时间"],
    "Logistics_Support": ["地址", "位置", "在哪里", "营业时间", "几点开门"],
    "Price_Inquiry": ["多少钱", "价格", "费用", "贵吗"],
    "Symptom_Check": ["疼", "痛", "出血", "松动"],
    "Procedure_Explain": ["什么是", "什么叫", "什么意思", "解释一下", "原理", "科普"],
    "Process_Flow": ["几次", "周期", "时间", "复诊", "多久"],
    "Comparative_Analysis": ["对比", "哪个好", "选哪个", "国产", "进口"],
